...
import {
  registerRequest,
  loginRequest,
  registerAbogaRequest,
  loginRequestAbogado,
  getAbogadosData,
  getAbogadoByCategoryRequest,
  verifyTokenRequest,
} from "../../api/auth";
...
export const AuthProvider = ({ children }) => {
  ...
  const getAbogado = async (category) => {
    try {
      const res = await getAbogadoByCategoryRequest(category);
      setAbogados(res.data.data);
    } catch (error) {
      console.log(error);
    }
  };
